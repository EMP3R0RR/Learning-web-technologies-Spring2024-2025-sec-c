...
//     
//     $stmt = $conn->prepare("SELECT first_name, last_name, email, department, age, blood_group, address, profilepic FROM students WHERE id = ?");
  ...
  <div class="dashboard">
    ...
    <div class="maindiv" id="mainContent" method="post" action="StudentProfile.php">
      <div class="profile-container">
        <div class="profile-header">Hello <?php echo htmlspecialchars($student['first_name']); ?>!!</div>
        ...
        <form class="profile-form" id="profileForm">
          <div>
            ...
            <input type="text" id="firstName" value="<?php echo htmlspecialchars($student['first_name']); ?>" disabled />
          </div>
          <div>
            <label>Last Name</label>
            <input type="text" id="lastName" value="<?php echo htmlspecialchars($student['last_name']); ?>" disabled />
          </div>
          <div>
            <label>Email</label>
          ...
          <div>
            ...
            <input type="text" id="department" value="<?php echo htmlspecialchars($student['department'] ?: ''); ?>"disabled />
          </div>
          <div>
            <label>Age</label>
          ...
          <div>
            ...
            <input type="text" id="bloodGroup" value="<?php echo htmlspecialchars($student['blood_group'] ?: ''); ?>" disabled />
          </div>
          <div class="full-width">
            <label>Address</label>
            <input type="text" id="address" value="<?php echo htmlspecialchars($student['address'] ?: ''); ?>" disabled />
          </div>
          <div class="full-width">
