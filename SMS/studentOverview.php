...
<body>
  ...
  <div class="dashboard">
    ...
    <div class="sidediv">
     <button onclick="window.location.href='AdminProfile.php'">Profile</button>
      <button onclick="window.location.href='studentOverview.php'">Student Overview</button>
      <button onclick="window.location.href='teacherOverview.php'">Teacher Overview</button>
      <button onclick="window.location.href='courseOverview.php'">Courses Overview</button>
    ...
    <div class="overview-container" id="studentListContainer">
      <h2>Student List</h2>
    ...
    <div class="overview-container" id="newStudentContainer">
      <h2>New Student</h2>
      <form id="newStudentForm" onsubmit="return validateNewStudentForm()">
    ...
    <!-- Delete Student -->
    <div class="overview-container" id="deleteStudentContainer">
      <h2>Delete Student</h2>
      <form id="deleteStudentForm" onsubmit="return confirmDelete()">
        <div class="search-form">
          <input type="email" name="deleteEmail" id="deleteStudentEmail" placeholder="Enter student email" required>
    ...
    <!-- Student Messages -->
    <div class="overview-container" id="studentMessageContainer">
      ...
      <table class="overview-table">
        ...
        <tbody>
          <tr>
            <td>Syed Punno</td>
            <td>Student@example.com</td>
            <td>Need help with registration.</td>
          </tr>
        </tbody>
      </table>
    </div>
...
<script>
    ...
    function confirmDelete() {
      const email = document.getElementById("deleteStudentEmail").value;
      if (!email) {
