...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Password is ignored (no database validation)
    ...
    if (empty($role) || !in_array($role, $valid_roles)) {
        ...
        // Login successful (no database check)
        // Set session variables
        $_SESSION['user_id'] = 1; // Static ID (no database)
        $_SESSION['role'] = $role;
  ...
  <div class="landing-header">
    <header>
      ...
      <nav>
        ...
        <button onclick="window.location.href='dummy2.php'">SIGNUP</button>
