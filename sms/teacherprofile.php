...
<body>
  ...
  <div class="dashboard">
    <div class="sidediv">
      <button onclick="window.location.href='teacherprofile.html'">Profile</button>
      <button onclick="window.location.href='schedule.html'">Schedule</button>
      <button onclick="window.location.href='gradesUpload.html'">Grades</button>
      <button onclick="window.location.href='assignment.html'">Assignments</button>
    </div>

    <div class="maindiv" id="mainContent">
      <div class="profile-container">
        <div class="profile-header">Hello Syed!!</div>
