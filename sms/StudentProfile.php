...
<body>
  ...
  <div class="dashboard">
    <div class="sidediv">
      ...
      <button onclick="window.location.href='grades.html'">Grades</button>
    ...
    <div class="maindiv" id="mainContent">
      <div class="profile-container">
        ...
        <form class="profile-form" id="profileForm"  method="post" action="StudentProfile.php" enctype="multipart/form-data">
          <div>
